...
snippet to do this is already provided on the [[https://wiki.xxiivv.com/site/uxntal_software.html][software page]]. It's quite clever
...
=emacs=, =emacs-lisp=, =uxntal=, or =tree-sitter=. But I've found a great [[https://www.masteringemacs.org/article/lets-write-a-treesitter-major-mode][article]] on how
to do this by Mickey Petersen on exactly this topic. In case it's useful to
anyone else, the code will be [[https://git.sr.ht/~nilaykumar/uxntal-ts-mode][here]]. Here's what it looks like so far:

#+ATTR_HTML: :alt screenshot of some dark-mode themed, syntax highlighted uxntal code
[[file:images/december-adventure-2025/uxntal-ts-major-mode.jpg]]
...
use are listed in the manual [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Faces-for-Font-Lock.html][here]]. For example, let's start by displaying
...
highlight both the rune's character and the identifier itself. We do /not/
...
system. The [[https://www.gnu.org/software/emacs/manual/html_node/elisp/Pattern-Matching.html][manual]] was kinda helpful, though I wish there were more concrete
