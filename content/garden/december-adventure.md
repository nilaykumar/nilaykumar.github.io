...
[merveilles.town](https://merveilles.town/)). It's already almost a good third of the way into December, but
...
FOSS workflow+raw developer software [darktable](https://www.darktable.org/) by [Kevin Ajili](https://youtu.be/ZUc6LOzg_Nk), and processed my
first photo.
...
[hanko](https://en.wikipedia.org/wiki/Seals_in_the_Sinosphere) made by the very kind Arami-san(荒見さん) at [Todo Insho](https://www.hanko-shibuya.com/en-us/) while I was in
...
ended up buying a [book](https://www.graphicsha.co.jp/detail.html?p=54933) on [seal script](https://en.wikipedia.org/wiki/Seal_script) in the design section of a bookstore in
Shibuya.

One part of the book that caught my eye was a page-and-a-half section on kakuji
(角字, literally: square/angled-letters). There's something [visually striking](https://en.wikipedia.org/wiki/Edomoji#/media/File:Kakuji_sample.png)
...
-   Black Silk, who seem to specialize in family crests/seals and related
    craftsmanship, have a [catalog of 角字](https://www.black-silk.com/crest-list/crest-kakuji/)
-   There's the Edomoji dictionary (江戸文字大字典) written by 日向数夫, which I
    can't figure out how to get a copy of. I learned of this from [two](https://youtu.be/welpJZSPtME) [videos](https://youtu.be/esBk7o3DcYs) on
    ...
    I'm asking here
-   An artist [Zenzo](https://www.zenzo.org/) who designs a few new kakuji every week

On radical-based decomposition of Chinese characters:

-   [Here](https://commons.wikimedia.org/wiki/Commons:Chinese_characters_decomposition) is a graphical decomposition of characters that I learned of from the
    website [kanji.club](https://kanji.club/), which may be of use here
-   A slightly tangential, but still interesting project called the [Recursive
    Radical Packing Language](https://github.com/LingDong-/rrpl)
...
> thought to have been influenced by the Chinese [nine-fold seal script](https://en.wikipedia.org/wiki/Nine-fold_seal_script) (九叠篆
